...
const ExpenseStats = async () => {
    try {
        ...
        return (
            <div className="bg-[#f4b9a4] dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl">
                <div className="flex items-center gap-3 mb-6">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#C15F3C] to-[#f98a62] rounded-xl flex items-center justify-center shadow-lg">
