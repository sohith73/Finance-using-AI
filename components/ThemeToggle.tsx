...
export default function ThemeToggle() {
    ...
    if (!mounted) {
        return (
            <div className="relative w-14 h-8 bg-gradient-to-r from-indigo-900/80 to-gray-700/80 backdrop-blur-sm rounded-full shadow-lg border border-indigo-400/30 dark:border-indigo-600/50">
                <div className="absolute top-0.5 left-0.5 w-7 h-7 bg-gray-200 dark:bg-gray-800 rounded-full shadow-md flex items-center justify-center transition-all duration-300 transform dark:translate-x-6">
                    <span className="text-sm dark:opacity-0">☀️</span>
                    <span className="absolute text-sm opacity-0 dark:opacity-100">
                        🌙
                    </span>
                </div>
            </div>
