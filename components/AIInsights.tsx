...
const AIInsights = () => {
    ...
    const getButtonColors = (type: string) => {
        switch (type) {
            ...
            case "tip":
                return "text-[#f46835] dark:text-emerald-300 hover:text-emerald-800 dark:hover:text-emerald-200";
            case "info":
                return "text-[#f46835] dark:text-emerald-300 hover:text-emerald-800 dark:hover:text-emerald-200";
            default:
    ...
    if (isLoading) {
        return (
            <div className="bg-[#f4b9a4] dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50">
                <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-[#C15F3C] to-[#f98a62] rounded-xl flex items-center justify-center shadow-lg">
                    ...
                    <div className="flex items-center gap-1 sm:gap-2">
                        ...
                        <span className="text-xs sm:text-sm text-[#C15F3C] dark:text-[#f98a62] font-medium hidden sm:block">
                            Analyzing...
                        </span>
                    </div>
                </div>
                ...
                <div className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-gray-100 dark:border-gray-700 text-center">
                    <div className="flex items-center justify-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                        <div className="w-1.5 h-1.5 from-[#C15F3C] to-[#f98a62] rounded-full animate-pulse"></div>
    ...
    return (
        <div className="bg-[#f4b9a4] dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl">
            <div className="flex items-center justify-between mb-4 sm:mb-6">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                    <div className="inline-flex items-center gap-2 bg-emerald-50 dark:bg-emerald-900/30 text-[#f46835] dark:text-emerald-300 px-2 py-1 rounded-full text-xs font-medium">
                    ...
                    <button
                        ...
                        className="w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-r from-[#C15F3C] to-[#f98a62]  hover:from-[#C15F3C] hover:via-[#e0693e] hover:to-[#f46835] text-white rounded-xl flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200"
                        disabled={isLoading}
                    >
                                    ...
                                    {currentAnswer && (
                                        <div className="mt-3 p-3 bg-white/70 dark:bg-gray-700/70 backdrop-blur-sm rounded-lg border border-gray-200 dark:border-gray-600">
                                            <div className="flex items-start gap-2">
                                                <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-br from-[#C15F3C] to-[#f98a62] rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
                    <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <span className="font-medium text-xs">
                            Powered by AI-BSC may contain some errors
                        </span>
                    </div>
                    <button
                        onClick={loadInsights}
                        className="px-3 py-1.5 bg-gradient-to-r from-[#C15F3C] to-[#f98a62]  hover:from-[#C15F3C] hover:via-[#e0693e] hover:to-[#f46835] text-white rounded-lg font-medium text-xs shadow-lg hover:shadow-xl transition-all duration-200"
                    >
